...
def crash():
    ...
    while True:
        ...
        button('MAIN MENU', width / 2 - button_w / 2, height / 2 + 3 * button_h / 2, button_w, button_h, red,
...
def paused():
    ...
    while pause:
        ...
        button('QUIT', width / 2 - button_w / 2, height / 2 + 3 * button_h / 2, button_w, button_h, red, bright_red,
               gameintro)
...
def gameloop():
    ...
    while True:
        ...
        if key_left and car_x > 0:
            car_x -= 5
        if key_right and car_x < width - car_w:
            car_x += 5
        block_y += block_speed
